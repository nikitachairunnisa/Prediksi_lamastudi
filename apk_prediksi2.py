...
kolom_model = ['JENIS KELAMIN', 'IP_S1', 'IP_S2', 'IP_S3', 'IP_S4', 'IP_S5', 'IP_S6', 'IPK']
...
def main():
    ...
    if prediksi_dari_file:
        ...
        IP_S6 = st.number_input('Inputkan Nilai IP Semester 6')
        ...
        if st.button('ESTIMASI LAMA STUDI'):
            ...
            if nilai_jenis_kelamin is not None:
                predict = model.predict([[nilai_jenis_kelamin, IP_S1, IP_S2, IP_S3, IP_S4, IP_S5, IP_S6, IPK]])
